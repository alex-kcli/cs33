...
0000000000400f90 <initialize_target>:
  ...
  400fa7:	e8 87 1c 00 00       	callq  402c33 <gencookie>
  400fac:	89 05 52 45 20 00    	mov    %eax,0x204552(%rip)        # 605504 <cookie>
  400fb2:	89 c7                	mov    %eax,%edi
  400fb4:	e8 7a 1c 00 00       	callq  402c33 <gencookie>
  ...
  4010ab:	00 
  4010ac:	e8 19 19 00 00       	callq  4029ca <init_driver>
...
00000000004010e0 <main>:
  ...
  401176:	ff 24 c5 58 2f 40 00 	jmpq   *0x402f58(,%rax,8)
  ...
  40126f:	e8 37 08 00 00       	callq  401aab <check_fail>
  ...
  401290:	e8 46 0c 00 00       	callq  401edb <launch>
...
0000000000401776 <getbuf>:
  ...
  40177d:	e8 58 03 00 00       	callq  401ada <Gets>
...
000000000040178c <touch1>:
  ...
  401797:	00 00 00 
  40179a:	bf 16 31 40 00       	mov    $0x403116,%edi
  40179f:	e8 ac f4 ff ff       	callq  400c50 <puts@plt>
  4017a4:	bf 01 00 00 00       	mov    $0x1,%edi
  4017a9:	e8 1b 05 00 00       	callq  401cc9 <validate>
...
000000000040180e <hexmatch>:
  ...
  401859:	be 33 31 40 00       	mov    $0x403133,%esi
...
00000000004018f0 <test>:
  ...
  401900:	bf d8 31 40 00       	mov    $0x4031d8,%edi
...
000000000040191a <getval_222>:
  40191a:	b8 48 89 c7 c3       	mov    $0xc3c78948,%eax
  40191f:	c3                   	retq   

0000000000401920 <setval_212>:
  401920:	c7 07 48 89 c7 c3    	movl   $0xc3c78948,(%rdi)
  401926:	c3                   	retq   

0000000000401927 <getval_214>:
  401927:	b8 58 91 90 90       	mov    $0x90909158,%eax
  40192c:	c3                   	retq   

000000000040192d <setval_252>:
  40192d:	c7 07 48 89 c7 91    	movl   $0x91c78948,(%rdi)
  401933:	c3                   	retq   

0000000000401934 <setval_495>:
  401934:	c7 07 40 89 c7 c3    	movl   $0xc3c78940,(%rdi)
  40193a:	c3                   	retq   

000000000040193b <getval_153>:
  40193b:	b8 d8 90 c3 24       	mov    $0x24c390d8,%eax
  401940:	c3                   	retq   

0000000000401941 <addval_157>:
  401941:	8d 87 ed a5 58 90    	lea    -0x6fa75a13(%rdi),%eax
  401947:	c3                   	retq   

0000000000401948 <setval_451>:
  401948:	c7 07 af 9d 58 c3    	movl   $0xc3589daf,(%rdi)
  40194e:	c3                   	retq   
...
000000000040195a <setval_289>:
  40195a:	c7 07 99 c1 90 90    	movl   $0x9090c199,(%rdi)
  401960:	c3                   	retq   

0000000000401961 <setval_478>:
  401961:	c7 07 89 ca c3 e3    	movl   $0xe3c3ca89,(%rdi)
  401967:	c3                   	retq   

0000000000401968 <addval_483>:
  401968:	8d 87 81 d6 38 d2    	lea    -0x2dc7297f(%rdi),%eax
  40196e:	c3                   	retq   

000000000040196f <addval_178>:
  40196f:	8d 87 89 c1 08 db    	lea    -0x24f73e77(%rdi),%eax
  401975:	c3                   	retq   

0000000000401976 <getval_101>:
  401976:	b8 ba 48 89 e0       	mov    $0xe08948ba,%eax
  40197b:	c3                   	retq   

000000000040197c <addval_216>:
  40197c:	8d 87 89 d6 84 c0    	lea    -0x3f7b2977(%rdi),%eax
  401982:	c3                   	retq   

0000000000401983 <addval_304>:
  401983:	8d 87 a9 c1 08 db    	lea    -0x24f73e57(%rdi),%eax
  401989:	c3                   	retq   

000000000040198a <addval_257>:
  40198a:	8d 87 89 c1 60 db    	lea    -0x249f3e77(%rdi),%eax
  401990:	c3                   	retq   

0000000000401991 <getval_326>:
  401991:	b8 4d be 89 d6       	mov    $0xd689be4d,%eax
  401996:	c3                   	retq   

0000000000401997 <addval_259>:
  401997:	8d 87 88 ca 90 90    	lea    -0x6f6f3578(%rdi),%eax
  40199d:	c3                   	retq   

000000000040199e <setval_413>:
  40199e:	c7 07 88 ca 84 c9    	movl   $0xc984ca88,(%rdi)
  4019a4:	c3                   	retq   

00000000004019a5 <addval_255>:
  4019a5:	8d 87 48 89 e0 91    	lea    -0x6e1f76b8(%rdi),%eax
  4019ab:	c3                   	retq   

00000000004019ac <addval_172>:
  4019ac:	8d 87 81 c1 38 c9    	lea    -0x36c73e7f(%rdi),%eax
  4019b2:	c3                   	retq   

00000000004019b3 <getval_203>:
  4019b3:	b8 8d c1 90 c3       	mov    $0xc390c18d,%eax
  4019b8:	c3                   	retq   

00000000004019b9 <setval_448>:
  4019b9:	c7 07 89 ca 92 90    	movl   $0x9092ca89,(%rdi)
  4019bf:	c3                   	retq   

00000000004019c0 <getval_376>:
  4019c0:	b8 e4 c8 89 e0       	mov    $0xe089c8e4,%eax
  4019c5:	c3                   	retq   

00000000004019c6 <addval_309>:
  4019c6:	8d 87 68 89 e0 c3    	lea    -0x3c1f7698(%rdi),%eax
  4019cc:	c3                   	retq   

00000000004019cd <getval_190>:
  4019cd:	b8 89 d6 91 c3       	mov    $0xc391d689,%eax
  4019d2:	c3                   	retq   

00000000004019d3 <setval_455>:
  4019d3:	c7 07 89 d6 18 db    	movl   $0xdb18d689,(%rdi)
  4019d9:	c3                   	retq   

00000000004019da <getval_486>:
  4019da:	b8 48 8b e0 90       	mov    $0x90e08b48,%eax
  4019df:	c3                   	retq   

00000000004019e0 <addval_394>:
  4019e0:	8d 87 09 d6 90 c3    	lea    -0x3c6f29f7(%rdi),%eax
  4019e6:	c3                   	retq   

00000000004019e7 <setval_273>:
  4019e7:	c7 07 2b 48 89 e0    	movl   $0xe089482b,(%rdi)
  4019ed:	c3                   	retq   

00000000004019ee <setval_464>:
  4019ee:	c7 07 89 c1 20 db    	movl   $0xdb20c189,(%rdi)
  4019f4:	c3                   	retq   

00000000004019f5 <addval_350>:
  4019f5:	8d 87 89 ca 94 d2    	lea    -0x2d6b3577(%rdi),%eax
  4019fb:	c3                   	retq   

00000000004019fc <setval_351>:
  4019fc:	c7 07 89 ca 38 c0    	movl   $0xc038ca89,(%rdi)
  401a02:	c3                   	retq   

0000000000401a03 <addval_296>:
  401a03:	8d 87 58 89 e0 90    	lea    -0x6f1f76a8(%rdi),%eax
  401a09:	c3                   	retq   

0000000000401a0a <getval_392>:
  401a0a:	b8 b6 89 d6 91       	mov    $0x91d689b6,%eax
  401a0f:	c3                   	retq   

0000000000401a10 <getval_125>:
  401a10:	b8 2d 4c 89 e0       	mov    $0xe0894c2d,%eax
  401a15:	c3                   	retq   

0000000000401a16 <getval_362>:
  401a16:	b8 c9 ca 20 d2       	mov    $0xd220cac9,%eax
  401a1b:	c3                   	retq   

0000000000401a1c <getval_151>:
  401a1c:	b8 8d ca 20 c9       	mov    $0xc920ca8d,%eax
  401a21:	c3                   	retq   

0000000000401a22 <getval_410>:
  401a22:	b8 89 d6 a4 c0       	mov    $0xc0a4d689,%eax
  401a27:	c3                   	retq   

0000000000401a28 <addval_417>:
  401a28:	8d 87 89 c1 78 d2    	lea    -0x2d873e77(%rdi),%eax
  401a2e:	c3                   	retq   
...
0000000000401aab <check_fail>:
  ...
  401ac1:	bf fb 31 40 00       	mov    $0x4031fb,%edi
  401ac6:	b8 00 00 00 00       	mov    $0x0,%eax
  401acb:	e8 b0 f1 ff ff       	callq  400c80 <printf@plt>
  401ad0:	bf 01 00 00 00       	mov    $0x1,%edi
  401ad5:	e8 16 f3 ff ff       	callq  400df0 <exit@plt>
...
0000000000401ada <Gets>:
  ...
  401b08:	e8 53 f2 ff ff       	callq  400d60 <_IO_getc@plt>
...
0000000000401b2c <notify_server>:
  ...
  401b53:	bf 30 33 40 00       	mov    $0x403330,%edi
  401b58:	b8 00 00 00 00       	mov    $0x0,%eax
  401b5d:	e8 1e f1 ff ff       	callq  400c80 <printf@plt>
  401b62:	bf 01 00 00 00       	mov    $0x1,%edi
  401b67:	e8 84 f2 ff ff       	callq  400df0 <exit@plt>
  ...
  401b90:	b9 11 32 40 00       	mov    $0x403211,%ecx
  401b95:	eb 05                	jmp    401b9c <notify_server+0x70>
  401b97:	b9 16 32 40 00       	mov    $0x403216,%ecx
  ...
  401bae:	be 1b 32 40 00       	mov    $0x40321b,%esi
  401bb3:	48 8d bc 24 10 20 00 	lea    0x2010(%rsp),%rdi
  401bba:	00 
  401bbb:	b8 00 00 00 00       	mov    $0x0,%eax
  401bc0:	e8 1b f2 ff ff       	callq  400de0 <sprintf@plt>
  ...
  401c08:	bf 37 32 40 00       	mov    $0x403237,%edi
  401c0d:	b8 00 00 00 00       	mov    $0x0,%eax
  401c12:	e8 69 f0 ff ff       	callq  400c80 <printf@plt>
  401c17:	bf 01 00 00 00       	mov    $0x1,%edi
  401c1c:	e8 cf f1 ff ff       	callq  400df0 <exit@plt>
  401c21:	bf 60 33 40 00       	mov    $0x403360,%edi
  401c26:	e8 25 f0 ff ff       	callq  400c50 <puts@plt>
  401c2b:	bf 43 32 40 00       	mov    $0x403243,%edi
  401c30:	e8 1b f0 ff ff       	callq  400c50 <puts@plt>
  401c35:	e9 85 00 00 00       	jmpq   401cbf <notify_server+0x193>
  401c3a:	bf 4d 32 40 00       	mov    $0x40324d,%edi
  401c3f:	e8 0c f0 ff ff       	callq  400c50 <puts@plt>
  401c44:	eb 79                	jmp    401cbf <notify_server+0x193>
  401c46:	85 db                	test   %ebx,%ebx
  401c48:	74 08                	je     401c52 <notify_server+0x126>
  401c4a:	be 11 32 40 00       	mov    $0x403211,%esi
  401c4f:	90                   	nop
  401c50:	eb 05                	jmp    401c57 <notify_server+0x12b>
  401c52:	be 16 32 40 00       	mov    $0x403216,%esi
  401c57:	bf 98 33 40 00       	mov    $0x403398,%edi
  401c5c:	b8 00 00 00 00       	mov    $0x0,%eax
  401c61:	e8 1a f0 ff ff       	callq  400c80 <printf@plt>
  401c66:	48 8b 35 f3 34 20 00 	mov    0x2034f3(%rip),%rsi        # 605160 <user_id>
  401c6d:	bf 54 32 40 00       	mov    $0x403254,%edi
  ...
  401c83:	bf 61 32 40 00       	mov    $0x403261,%edi
  401c88:	b8 00 00 00 00       	mov    $0x0,%eax
  401c8d:	e8 ee ef ff ff       	callq  400c80 <printf@plt>
  401c92:	48 8b 35 d7 34 20 00 	mov    0x2034d7(%rip),%rsi        # 605170 <lab>
  401c99:	bf 6d 32 40 00       	mov    $0x40326d,%edi
  401c9e:	b8 00 00 00 00       	mov    $0x0,%eax
  401ca3:	e8 d8 ef ff ff       	callq  400c80 <printf@plt>
  401ca8:	48 8d b4 24 10 20 00 	lea    0x2010(%rsp),%rsi
  401caf:	00 
  401cb0:	bf 76 32 40 00       	mov    $0x403276,%edi
  401cb5:	b8 00 00 00 00       	mov    $0x0,%eax
  401cba:	e8 c1 ef ff ff       	callq  400c80 <printf@plt>
...
0000000000401cc9 <validate>:
  ...
  401cdd:	bf 82 32 40 00       	mov    $0x403282,%edi
  401ce2:	e8 69 ef ff ff       	callq  400c50 <puts@plt>
  ...
  401cfd:	bf c0 33 40 00       	mov    $0x4033c0,%edi
  ...
  401d24:	bf a0 32 40 00       	mov    $0x4032a0,%edi
  401d29:	b8 00 00 00 00       	mov    $0x0,%eax
  401d2e:	e8 4d ef ff ff       	callq  400c80 <printf@plt>
  ...
  401d3d:	bf 82 32 40 00       	mov    $0x403282,%edi
  401d42:	e8 09 ef ff ff       	callq  400c50 <puts@plt>
  ...
  401d5e:	bf e8 33 40 00       	mov    $0x4033e8,%edi
  401d63:	b8 00 00 00 00       	mov    $0x0,%eax
  401d68:	e8 13 ef ff ff       	callq  400c80 <printf@plt>
...
0000000000401da3 <bushandler>:
  ...
  401db0:	bf b5 32 40 00       	mov    $0x4032b5,%edi
  ...
  401dc4:	bf 20 34 40 00       	mov    $0x403420,%edi
  401dc9:	e8 82 ee ff ff       	callq  400c50 <puts@plt>
  401dce:	bf bf 32 40 00       	mov    $0x4032bf,%edi
  401dd3:	e8 78 ee ff ff       	callq  400c50 <puts@plt>
  ...
  401dec:	e8 ff ef ff ff       	callq  400df0 <exit@plt>
...
0000000000401df1 <seghandler>:
  ...
  401dfe:	bf d5 32 40 00       	mov    $0x4032d5,%edi
  401e03:	e8 48 ee ff ff       	callq  400c50 <puts@plt>
  401e08:	b8 00 00 00 00       	mov    $0x0,%eax
  401e0d:	e8 99 fc ff ff       	callq  401aab <check_fail>
  401e12:	bf 40 34 40 00       	mov    $0x403440,%edi
  401e17:	e8 34 ee ff ff       	callq  400c50 <puts@plt>
  401e1c:	bf bf 32 40 00       	mov    $0x4032bf,%edi
  ...
  401e3a:	e8 b1 ef ff ff       	callq  400df0 <exit@plt>
...
0000000000401e3f <illegalhandler>:
  ...
  401e4c:	bf e8 32 40 00       	mov    $0x4032e8,%edi
  401e51:	e8 fa ed ff ff       	callq  400c50 <puts@plt>
  401e56:	b8 00 00 00 00       	mov    $0x0,%eax
  401e5b:	e8 4b fc ff ff       	callq  401aab <check_fail>
  401e60:	bf 68 34 40 00       	mov    $0x403468,%edi
  401e65:	e8 e6 ed ff ff       	callq  400c50 <puts@plt>
  401e6a:	bf bf 32 40 00       	mov    $0x4032bf,%edi
  401e6f:	e8 dc ed ff ff       	callq  400c50 <puts@plt>
  ...
  401e88:	e8 63 ef ff ff       	callq  400df0 <exit@plt>
...
0000000000401e8d <sigalrmhandler>:
  ...
  401e9a:	bf fc 32 40 00       	mov    $0x4032fc,%edi
  401e9f:	e8 ac ed ff ff       	callq  400c50 <puts@plt>
  401ea4:	b8 00 00 00 00       	mov    $0x0,%eax
  401ea9:	e8 fd fb ff ff       	callq  401aab <check_fail>
  401eae:	be 05 00 00 00       	mov    $0x5,%esi
  401eb3:	bf 98 34 40 00       	mov    $0x403498,%edi
  401eb8:	b8 00 00 00 00       	mov    $0x0,%eax
  401ebd:	e8 be ed ff ff       	callq  400c80 <printf@plt>
  ...
  401ed6:	e8 15 ef ff ff       	callq  400df0 <exit@plt>
...
0000000000401edb <launch>:
  ...
  401efb:	e8 90 ed ff ff       	callq  400c90 <memset@plt>
...
0000000000401f5c <stable_launch>:
  ...
  401f84:	e8 e7 ec ff ff       	callq  400c70 <mmap@plt>
  ...
  402002:	e8 79 ed ff ff       	callq  400d80 <munmap@plt>
  402007:	5b                   	pop    %rbx
  402008:	c3                   	retq   
...
0000000000402022 <sigalrm_handler>:
  ...
  40203c:	e8 bf ec ff ff       	callq  400d00 <fprintf@plt>
  402041:	bf 01 00 00 00       	mov    $0x1,%edi
  402046:	e8 a5 ed ff ff       	callq  400df0 <exit@plt>
...
000000000040204b <urlencode>:
  ...
  4020de:	e8 fd ec ff ff       	callq  400de0 <sprintf@plt>
...
0000000000402121 <rio_writen>:
  ...
  402142:	e8 19 eb ff ff       	callq  400c60 <write@plt>
  402147:	48 85 c0             	test   %rax,%rax
  40214a:	7f 0f                	jg     40215b <rio_writen+0x3a>
  40214c:	e8 bf ea ff ff       	callq  400c10 <__errno_location@plt>
...
000000000040217d <rio_read>:
  ...
  40219e:	e8 1d eb ff ff       	callq  400cc0 <read@plt>
  4021a3:	89 43 04             	mov    %eax,0x4(%rbx)
  4021a6:	85 c0                	test   %eax,%eax
  4021a8:	79 0c                	jns    4021b6 <rio_read+0x39>
  4021aa:	e8 61 ea ff ff       	callq  400c10 <__errno_location@plt>
  ...
  4021dc:	e8 4f eb ff ff       	callq  400d30 <memcpy@plt>
...
0000000000402287 <submitr>:
  ...
  4022cf:	e8 3c eb ff ff       	callq  400e10 <socket@plt>
  ...
  40232b:	e8 c0 e9 ff ff       	callq  400cf0 <gethostbyname@plt>
  ...
  4023d1:	e8 ba e9 ff ff       	callq  400d90 <bcopy@plt>
  ...
  4023f6:	e8 05 ea ff ff       	callq  400e00 <connect@plt>
  ...
  402449:	e8 62 e8 ff ff       	callq  400cb0 <close@plt>
  ...
  40250d:	e8 9e e7 ff ff       	callq  400cb0 <close@plt>
  ...
  4025bf:	e8 ec e6 ff ff       	callq  400cb0 <close@plt>
  ...
  4025f1:	e8 ea e7 ff ff       	callq  400de0 <sprintf@plt>
  ...
  402686:	e8 25 e6 ff ff       	callq  400cb0 <close@plt>
  ...
  402731:	e8 7a e5 ff ff       	callq  400cb0 <close@plt>
  ...
  402767:	e8 04 e6 ff ff       	callq  400d70 <__isoc99_sscanf@plt>
  ...
  4027fa:	e8 b1 e4 ff ff       	callq  400cb0 <close@plt>
  ...
  4028fa:	e8 e1 e4 ff ff       	callq  400de0 <sprintf@plt>
  4028ff:	89 ef                	mov    %ebp,%edi
  402901:	e8 aa e3 ff ff       	callq  400cb0 <close@plt>
  ...
  40291b:	e8 20 e3 ff ff       	callq  400c40 <strcpy@plt>
  402920:	89 ef                	mov    %ebp,%edi
  402922:	e8 89 e3 ff ff       	callq  400cb0 <close@plt>
...
00000000004029a2 <init_timeout>:
  ...
  4029c3:	e8 d8 e2 ff ff       	callq  400ca0 <alarm@plt>
  4029c8:	5b                   	pop    %rbx
  4029c9:	c3                   	retq   
...
00000000004029ca <init_driver>:
  ...
  402a69:	bf 30 30 40 00       	mov    $0x403030,%edi
  402a6e:	e8 7d e2 ff ff       	callq  400cf0 <gethostbyname@plt>
  ...
  402ad1:	e8 da e1 ff ff       	callq  400cb0 <close@plt>
  ...
  402b07:	e8 84 e2 ff ff       	callq  400d90 <bcopy@plt>
  402b0c:	66 c7 44 24 02 3b 6e 	movw   $0x6e3b,0x2(%rsp)
  402b13:	ba 10 00 00 00       	mov    $0x10,%edx
  402b18:	48 89 e6             	mov    %rsp,%rsi
  402b1b:	89 df                	mov    %ebx,%edi
  402b1d:	e8 de e2 ff ff       	callq  400e00 <connect@plt>
...
0000000000402b93 <driver_post>:
  ...
  402bad:	e8 ce e0 ff ff       	callq  400c80 <printf@plt>
  ...
  402bdc:	be 6e 3b 00 00       	mov    $0x3b6e,%esi
  402be1:	bf 30 30 40 00       	mov    $0x403030,%edi
...
0000000000402c33 <gencookie>:
  ...
  402c37:	e8 e4 df ff ff       	callq  400c20 <srandom@plt>
  402c3c:	e8 0f e1 ff ff       	callq  400d50 <random@plt>
...
0000000000402c60 <__libc_csu_init>:
  ...
  402c78:	55                   	push   %rbp
  402c79:	48 8d 2d 98 21 20 00 	lea    0x202198(%rip),%rbp        # 604e18 <__init_array_end>
  402c80:	53                   	push   %rbx
  402c81:	4c 29 e5             	sub    %r12,%rbp
  402c84:	31 db                	xor    %ebx,%ebx
  402c86:	48 c1 fd 03          	sar    $0x3,%rbp
  402c8a:	48 83 ec 08          	sub    $0x8,%rsp
  402c8e:	e8 35 df ff ff       	callq  400bc8 <_init>
